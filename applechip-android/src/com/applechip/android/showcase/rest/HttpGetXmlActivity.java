...
import com.applechip.android.showcase.AbstractAsyncListActivity;
	...
	private class DownloadStatesTask extends AsyncTask<Void, Void, List<State>> {
		...
		protected List<State> doInBackground(Void... params) {
			try {
				...
				ResponseEntity<StateList> responseEntity = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
						StateList.class);
