...
public class SecurityUtil {
	...
	public static String encrypt(String decryptText) {
		...
		try {
			...
			decrypt = StringUtil
					.newStringUtf8(Base64.encodeBase64(cipher.doFinal(StringUtil.getBytesUtf8(decryptText))));
		}
	...
	public static String decrypt(String encryptText) {
		...
		try {
			...
			decrypt = StringUtil
					.newStringUtf8(cipher.doFinal(Base64.decodeBase64(StringUtil.getBytesUtf8(encryptText))));
		}
		catch (GeneralSecurityException e) {
