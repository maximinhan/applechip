...
public class CoreConstant {
	...
	private static final String APPLECHIP_HOME = String.format("%s%s.applechip", USER_HOME, FILE_SEPARATOR);

	public static final String STORAGE_PATH = String.format("%s%sstorage", APPLECHIP_HOME, FILE_SEPARATOR);

	private static final String CONFIG_PROPERTIES = "config.properties";

	public static final String CONFIG_PROPERTIES_DEVELOPMENT = String.format("classpath:%s", CONFIG_PROPERTIES);
