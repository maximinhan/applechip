...
public class WebWebMvcConfigurer extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.setOrder(-10).addResourceHandler("version.txt")
				.addResourceLocations("version.txt", "classpath:/META-INF/version.txt");
	 ...
	 * 
	 * @RequestMapping("favicon.ico") String favicon() { return "forward:/resources/images/favicon.ico"; } }
	 * 
	 ...
	 * 
	 * <definition name="defaultLayout" template="/WEB-INF/view/common/layout/default/layout.jsp"> <put-attribute
	 * name="header" value="/WEB-INF/view/common/layout/default/header.jsp" /> <put-attribute name="left"
	 * value="/WEB-INF/view/common/layout/default/left.jsp" /> <put-attribute name="body"
	 * value="/WEB-INF/view/common/layout/default/blank.jsp" /> <put-attribute name="footer"
	 * value="/WEB-INF/view/common/layout/default/footer.jsp" /> </definition>
	 * 
	 * 
	 * <definition name="main" extends="defaultLayout"> <put-attribute name="body" value="/WEB-INF/view/main/main.jsp"
	 * /> <put-attribute name="left" value="/WEB-INF/view/main/leftMain.jsp" /> </definition>
	 * 
	 * 
	 ...
	 * 
	 * <definition name="preparer.definition" preparer="org.apache.tiles.test.preparer.TestViewPreparer"> <put-attribute
	 * name="foo" value="/bar/foo.jsp" /> </definition>
	 * 
	 * 
